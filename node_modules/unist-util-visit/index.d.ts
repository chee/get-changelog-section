...
>(
  tree: Tree,
  test: Check,
  visitor: import('unist-util-visit/complex-types').BuildVisitor<Tree, Check>,
  reverse?: boolean | undefined
) => void) &
  (<Tree_1 extends import('unist').Node<import('unist').Data>>(
    tree: Tree_1,
    visitor: import('unist-util-visit/complex-types').BuildVisitor<Tree_1, string>,
    reverse?: boolean | undefined
  ) => void)
...
export type Visitor = import('unist-util-visit/complex-types').Visitor
